...
#export PS1="demo@machine ➜ ~/project $ "
#run the program with the command: python -m test_scanner_ver.main -l . -f test -e output -x "Compra INTL Spotify, Pago Autom TC Master Pesos, Transferencia a Nequi, Pago App Empacadas, Pago PSE Colombia Telecomunic, Pago App Claro Movil Comcel " -n 1 -q -d facturas
